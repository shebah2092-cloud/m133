...
class HILBridge:
    ...
    def __init__(self, cfg_path: str):
        ...
        # ─── إعدادات فيدباك السيرفو (HIL feature) ─────────────────────────
        # في HIL: السيرفوهات حقيقية على CAN. نقرأ زاوية السيرفو الفعلية
        # من SRV_FB (DEBUG_FLOAT_ARRAY id=1) ونُرجعها للمحاكاة بدلاً من
        # الأمر المثالي، لإغلاق الحلقة ميكانيكياً.
